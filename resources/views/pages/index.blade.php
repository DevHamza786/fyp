...
@section('content')
                ...
                <div class="row row-gutter-20">
                    <div class="col-sm-6 col-lg-3">
                        ...
                        <div class="job-category-item">
                            <div class="content">
                                <h3 class="title"><a href="{{ route('job-details') }}">Accounting/Finance <span>(305)</span></a></h3>
                            </div>
                            <a class="overlay-link" href="{{ route('job-details') }}"></a>
                        </div>
                    ...
                    <div class="col-sm-6 col-lg-3">
                        ...
                        <div class="job-category-item">
                            <div class="content">
                                <h3 class="title"><a href="{{ route('job-details') }}">Production/Operation <span>(95)</span></a>
                                </h3>
                            </div>
                            <a class="overlay-link" href="{{ route('job-details') }}"></a>
                        </div>
                    ...
                    <div class="col-sm-6 col-lg-3">
                        ...
                        <div class="job-category-item">
                            <div class="content">
                                <h3 class="title"><a href="{{ route('job-details') }}">Education/Training <span>(212)</span></a>
                                </h3>
                            </div>
                            <a class="overlay-link" href="{{ route('job-details') }}"></a>
                        </div>
                    ...
                    <div class="col-sm-6 col-lg-3">
                        ...
                        <div class="job-category-item">
                            <div class="content">
                                <h3 class="title"><a href="{{ route('job-details') }}">Design/Creative <span>(93)</span></a></h3>
                            </div>
                            <a class="overlay-link" href="{{ route('job-details') }}"></a>
                        </div>
                        <!--== End Job Category Item ==-->
                    ...
                    <div class="col-sm-6 col-lg-3">
                        ...
                        <div class="job-category-item">
                            <div class="content">
                                <h3 class="title"><a href="{{ route('job-details') }}">Health & Fitness <span>(4)</span></a></h3>
                            </div>
                            <a class="overlay-link" href="{{ route('job-details') }}"></a>
                        </div>
                        <!--== End Job Category Item ==-->
                    ...
                    <div class="col-sm-6 col-lg-3">
                        ...
                        <div class="job-category-item">
                            <div class="content">
                                <h3 class="title"><a href="{{ route('job-details') }}">Research/Consultancy <span>(34)</span></a>
                                </h3>
                            </div>
                            <a class="overlay-link" href="{{ route('job-details') }}"></a>
                        </div>
                    ...
                    <div class="col-sm-6 col-lg-3">
                        ...
                        <div class="job-category-item">
                            <div class="content">
                                <h3 class="title"><a href="{{ route('job-details') }}">Engineer/Architects <span>(376)</span></a>
                                </h3>
                            </div>
                            <a class="overlay-link" href="{{ route('job-details') }}"></a>
                        </div>
                    ...
                    <div class="col-sm-6 col-lg-3">
                        ...
                        <div class="job-category-item">
                            <div class="content">
                                <h3 class="title"><a href="{{ route('job-details') }}">Telecommunication <span>(450)</span></a>
                                </h3>
                            </div>
                            <a class="overlay-link" href="{{ route('job-details') }}"></a>
                        </div>
                    ...
                    <div class="col-sm-6 col-lg-3">
                        ...
                        <div class="job-category-item">
                            <div class="content">
                                <h3 class="title"><a href="{{ route('job-details') }}">Data Entry/Operator <span>(25)</span></a>
                                </h3>
                            </div>
                            <a class="overlay-link" href="{{ route('job-details') }}"></a>
                        </div>
                    ...
                    <div class="col-sm-6 col-lg-3">
                        ...
                        <div class="job-category-item">
                            <div class="content">
                                <h3 class="title"><a href="{{ route('job-details') }}">Marketing/Sales <span>(666)</span></a></h3>
                            </div>
                            <a class="overlay-link" href="{{ route('job-details') }}"></a>
                        </div>
                        <!--== End Job Category Item ==-->
                    ...
                    <div class="col-sm-6 col-lg-3">
                        ...
                        <div class="job-category-item">
                            <div class="content">
                                <h3 class="title"><a href="{{ route('job-details') }}">Security/Support Service
                                        <span>(62)</span></a></h3>
                            </div>
                            <a class="overlay-link" href="{{ route('job-details') }}"></a>
                        </div>
                ...
                <div class="row">
                    <div class="col-md-6 col-lg-4">
                        ...
                        <div class="recent-job-item">
                            <div class="company-info">
                                <div class="logo">
                                    <a href="{{ route('company-details') }}"><img src="assets/img/companies/1.jpg" width="75"
                    ...
                    <div class="col-md-6 col-lg-4">
                        ...
                        <div class="recent-job-item">
                            <div class="company-info">
                                <div class="logo">
                                    <a href="{{ route('company-details') }}"><img src="assets/img/companies/2.jpg" width="75"
                                            height="75" alt="Image-HasTech"></a>
                                </div>
                                <div class="content">
                    ...
                    <div class="col-md-6 col-lg-4">
                        ...
                        <div class="recent-job-item">
                            <div class="company-info">
                                <div class="logo">
                                    <a href="{{ route('company-details') }}"><img src="assets/img/companies/3.jpg" width="75"
                                            height="75" alt="Image-HasTech"></a>
                                </div>
                                <div class="content">
                    ...
                    <div class="col-md-6 col-lg-4">
                        ...
                        <div class="recent-job-item">
                            <div class="company-info">
                                <div class="logo">
                                    <a href="{{ route('company-details') }}"><img src="assets/img/companies/4.jpg" width="75"
                                            height="75" alt="Image-HasTech"></a>
                                </div>
                                <div class="content">
                    ...
                    <div class="col-md-6 col-lg-4">
                        ...
                        <div class="recent-job-item">
                            <div class="company-info">
                                <div class="logo">
                                    <a href="{{ route('company-details') }}"><img src="assets/img/companies/5.jpg" width="75"
                                            height="75" alt="Image-HasTech"></a>
                                </div>
                                <div class="content">
                    ...
                    <div class="col-md-6 col-lg-4">
                        ...
                        <div class="recent-job-item">
                            <div class="company-info">
                                <div class="logo">
                                    <a href="{{ route('company-details') }}"><img src="assets/img/companies/6.jpg" width="75"
                                            height="75" alt="Image-HasTech"></a>
                                </div>
                                <div class="content">
                    ...
                    <div class="col-md-6 col-lg-4">
                        ...
                        <div class="recent-job-item">
                            <div class="company-info">
                                <div class="logo">
                                    <a href="{{ route('company-details') }}"><img src="assets/img/companies/7.jpg" width="75"
                                            height="75" alt="Image-HasTech"></a>
                                </div>
                                <div class="content">
                                    <h4 class="name"><a href="{{ route('company-details') }}">Darkento Ltd.</a></h4>
                    ...
                    <div class="col-md-6 col-lg-4">
                        ...
                        <div class="recent-job-item">
                            <div class="company-info">
                                <div class="logo">
                                    <a href="{{ route('company-details') }}"><img src="assets/img/companies/8.jpg" width="75"
                                            height="75" alt="Image-HasTech"></a>
                                </div>
                                <div class="content">
                                    <h4 class="name"><a href="{{ route('company-details') }}">Inspire Fitness Co.</a></h4>
                    ...
                    <div class="col-md-6 col-lg-4">
                        ...
                        <div class="recent-job-item">
                            <div class="company-info">
                                <div class="logo">
                                    <a href="{{ route('company-details') }}"><img src="assets/img/companies/9.jpg" width="75"
                                            height="75" alt="Image-HasTech"></a>
                                </div>
                                <div class="content">
                                    <h4 class="name"><a href="{{ route('company-details') }}">Cogent Data</a></h4>
    ...
    <div class="bg-layer-style2"></div>
        ...
        <!--== Start Team Area Wrapper ==-->candidate-details.html
                                    ...
                                    <div class="testimonial-item">
                                        <div class="testi-inner-content">
                                            ...
                                            <div class="testi-content">
                                                <p class="desc">It is a long established fact that reader will distracted
                                                    the readable content page looking at its layout point using that has
                                                    more-or-less normal distribution of letters opposed using content
                                                    making.</p>
                                                <div class="rating-box">
                                                    <i class="icofont-star"></i>
                                                    <i class="icofont-star"></i>
            ...
            <div class="container">
                ...
                <div class="row align-items-center post-home-style row-gutter-40">
                    <div class="col-md-6 col-lg-4" data-aos="fade-right">
                        ...
                        <div class="post-item">
                            <div class="thumb">
                                <a href="blog-details.html"><img src="assets/img/blog/1.jpg" alt="Image"
