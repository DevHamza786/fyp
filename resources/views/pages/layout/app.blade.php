...
<head>
    ...
    <meta name="description" content="Job Hunter"/>
              ...
              <div class="header-align-center">
                <div class="header-navigation-area position-relative">
                  <ul class="main-menu nav">
                    ...
                    <li class="has-submenu"><a href="{{ route('job') }}"><span>Find Jobs</span></a>
                      {{-- <ul class="submenu-nav">
                        <li><a href="{{ route('job') }}"><span>Jobs</span></a></li>
                        <li><a href="job-details.html"><span>Job Details</span></a></li>
                      </ul> --}}
                    </li>
                    <li><a href="{{route('company-details')}}"><span>Company Details</span></a></li>
                    <li class="has-submenu"><a href="{{ route('candidate') }}"><span>Candidates</span></a>
                      {{-- <ul class="submenu-nav">
                      ...
                      <div class="collapse-body">
                        <div class="widget-menu-wrap">
                          <ul class="nav-menu">
                            ...
                            <li><a href="{{ route('contact') }}">Our Partners</a></li>
                          </ul>
                        </div>
                      </div>
                    </div>
                  ...
                  <div class="widget-item nav-menu-item2">
                    ...
                    <div id="widgetId-2" class="collapse widget-collapse-body">
                      <div class="collapse-body">
                        <div class="widget-menu-wrap">
                          <ul class="nav-menu">
                            <li><a href="{{ route('login') }}">Quick Links</a></li>
                            <li><a href="{{ route('job') }}">Jobs Listing</a></li>
                          </ul>
                        </div>
                      </div>
                    </div>
          ...
          <div class="row">
            <div class="col-12">
              <div class="footer-bottom-content">
                <p class="copyright">© 2021 Finate. Made with <i class="icofont-heart"></i> by <a target="_blank" href="{{ route('home') }}">Job Hunter.</a></p>
              </div>
            </div>
          </div>
        </div>
