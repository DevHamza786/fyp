          ...
          <div class="col-lg-7 col-xl-8">
            <div class="job-details-item">
              ...
              <div class="content">
                ...
                <a class="btn-apply-now" href="{{ route('contact') }}">Apply Now <i class="icofont-long-arrow-right"></i></a>
              </div>
            </div>
          </div>
            ...
            <div class="job-sidebar">
              ...
              <div class="widget-item widget-tag">
                ...
                <div class="widget-tag-list">
                  <a href="{{ route('job') }}">Cleaning</a>
                  <a href="{{ route('job') }}">Cleaning Agency</a><br>
                  <a href="{{ route('job') }}">Business</a>
                  <a href="{{ route('job') }}">Cleaning</a>
                  <a href="{{ route('job') }}">Business</a>
                  <a href="{{ route('job') }}">Cleaning</a>
                  <a href="{{ route('job') }}">Cleaning Agency</a>
                  <a href="{{ route('job') }}">Business</a>
                  <a href="{{ route('job') }}">Cleaning Agency</a>
                  <a href="{{ route('job') }}">Cleaning</a>
                  <a href="{{ route('job') }}">Business</a>
